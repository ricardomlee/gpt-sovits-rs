...
cargo build --profile dev-gpu --features cuda,onnx
cargo run --profile dev-gpu --features cuda,onnx -- --text "你好" ...
```
...
```bash
SOVITS_DEBUG=1 cargo run --profile dev-gpu --features cuda,onnx -- ...
