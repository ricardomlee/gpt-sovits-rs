...
fn pinyin_split() -> HashMap<&'static str, (&'static str, &'static str)> {
    ...
    map.insert("bai", ("b", "ai"));
    map.insert("ban", ("b", "an"));
    map.insert("bang", ("b", "ang"));
    map.insert("bao", ("b", "ao"));
    map.insert("bei", ("b", "e"));
    map.insert("ben", ("b", "en"));
    map.insert("beng", ("b", "eng"));
    map.insert("bi", ("b", "i"));
    map.insert("bian", ("b", "ian"));
    map.insert("biao", ("b", "iao"));
    map.insert("bie", ("b", "ie"));
    map.insert("bin", ("b", "in"));
    map.insert("bing", ("b", "ing"));
    map.insert("bo", ("b", "o"));
    map.insert("bu", ("b", "u"));
    // c
    map.insert("ca", ("c", "a"));
    map.insert("cai", ("c", "ai"));
    map.insert("can", ("c", "an"));
    map.insert("cang", ("c", "ang"));
    map.insert("cao", ("c", "ao"));
    map.insert("ce", ("c", "e"));
    map.insert("cei", ("c", "e"));
    map.insert("cen", ("c", "en"));
    map.insert("ceng", ("c", "eng"));
    map.insert("ci", ("c", "ir"));
    map.insert("cong", ("c", "ong"));
    map.insert("cou", ("c", "ou"));
    map.insert("cu", ("c", "u"));
    map.insert("cuan", ("c", "uan"));
    map.insert("cui", ("c", "ui"));
    map.insert("cun", ("c", "un"));
    map.insert("cuo", ("c", "uo"));
    // d
    ...
    map.insert("dai", ("d", "ai"));
    map.insert("dan", ("d", "an"));
    map.insert("dang", ("d", "ang"));
    map.insert("dao", ("d", "ao"));
    map.insert("de", ("d", "e"));
    map.insert("dei", ("d", "e"));
    map.insert("den", ("d", "en"));
    map.insert("deng", ("d", "eng"));
    map.insert("di", ("d", "i"));
    map.insert("dia", ("d", "ia"));
    map.insert("dian", ("d", "ian"));
    map.insert("diao", ("d", "iao"));
    map.insert("die", ("d", "ie"));
    map.insert("ding", ("d", "ing"));
    map.insert("diu", ("d", "iu"));
    map.insert("dong", ("d", "ong"));
    map.insert("dou", ("d", "ou"));
    map.insert("du", ("d", "u"));
    map.insert("duan", ("d", "uan"));
    map.insert("dui", ("d", "ui"));
    map.insert("dun", ("d", "un"));
    map.insert("duo", ("d", "uo"));
    // f
    map.insert("fa", ("f", "a"));
    map.insert("fan", ("f", "an"));
    map.insert("fang", ("f", "ang"));
    map.insert("fei", ("f", "e"));
    map.insert("fen", ("f", "en"));
    map.insert("feng", ("f", "eng"));
    map.insert("fo", ("f", "o"));
    map.insert("fou", ("f", "ou"));
    map.insert("fu", ("f", "u"));
    // g
    ...
    map.insert("gai", ("g", "ai"));
    map.insert("gan", ("g", "an"));
    map.insert("gang", ("g", "ang"));
    map.insert("gao", ("g", "ao"));
    map.insert("ge", ("g", "e"));
    map.insert("gei", ("g", "e"));
    map.insert("gen", ("g", "en"));
    map.insert("geng", ("g", "eng"));
    map.insert("gong", ("g", "ong"));
    map.insert("gou", ("g", "ou"));
    map.insert("gu", ("g", "u"));
    map.insert("gua", ("g", "ua"));
    map.insert("guai", ("g", "uai"));
    map.insert("guan", ("g", "uan"));
    map.insert("guang", ("g", "uang"));
    map.insert("gui", ("g", "ui"));
    map.insert("gun", ("g", "un"));
    map.insert("guo", ("g", "uo"));
    // h
    ...
    map.insert("hai", ("h", "ai"));
    map.insert("han", ("h", "an"));
    map.insert("hang", ("h", "ang"));
    map.insert("hao", ("h", "ao"));
    map.insert("he", ("h", "e"));
    map.insert("hei", ("h", "e"));
    map.insert("hen", ("h", "en"));
    map.insert("heng", ("h", "eng"));
    map.insert("hong", ("h", "ong"));
    map.insert("hou", ("h", "ou"));
    map.insert("hu", ("h", "u"));
    map.insert("hua", ("h", "ua"));
    map.insert("huai", ("h", "uai"));
    map.insert("huan", ("h", "uan"));
    map.insert("huang", ("h", "uang"));
    map.insert("hui", ("h", "ui"));
    map.insert("hun", ("h", "un"));
    map.insert("huo", ("h", "uo"));
    // j
    map.insert("ji", ("j", "i"));
    map.insert("jia", ("j", "ia"));
    map.insert("jian", ("j", "ian"));
    map.insert("jiang", ("j", "iang"));
    map.insert("jiao", ("j", "iao"));
    map.insert("jie", ("j", "ie"));
    map.insert("jin", ("j", "in"));
    map.insert("jing", ("j", "ing"));
    map.insert("jiong", ("j", "iong"));
    map.insert("jiu", ("j", "iu"));
    map.insert("ju", ("j", "v"));
    ...
    map.insert("kai", ("k", "ai"));
    map.insert("kan", ("k", "an"));
    map.insert("kang", ("k", "ang"));
    map.insert("kao", ("k", "ao"));
    map.insert("ke", ("k", "e"));
    map.insert("kei", ("k", "e"));
    map.insert("ken", ("k", "en"));
    map.insert("keng", ("k", "eng"));
    map.insert("kong", ("k", "ong"));
    map.insert("kou", ("k", "ou"));
    map.insert("ku", ("k", "u"));
    map.insert("kua", ("k", "ua"));
    map.insert("kuai", ("k", "uai"));
    map.insert("kuan", ("k", "uan"));
    map.insert("kuang", ("k", "uang"));
    map.insert("kui", ("k", "ui"));
    map.insert("kun", ("k", "un"));
    map.insert("kuo", ("k", "uo"));
    // l
    ...
    map.insert("lai", ("l", "ai"));
    map.insert("lan", ("l", "an"));
    map.insert("lang", ("l", "ang"));
    map.insert("lao", ("l", "ao"));
    map.insert("le", ("l", "e"));
    map.insert("lei", ("l", "e"));
    map.insert("leng", ("l", "eng"));
    map.insert("li", ("l", "i"));
    map.insert("lia", ("l", "ia"));
    map.insert("lian", ("l", "ian"));
    map.insert("liang", ("l", "iang"));
    map.insert("liao", ("l", "iao"));
    map.insert("lie", ("l", "ie"));
    map.insert("lin", ("l", "in"));
    map.insert("ling", ("l", "ing"));
    map.insert("liu", ("l", "iu"));
    map.insert("long", ("l", "ong"));
    map.insert("lou", ("l", "ou"));
    map.insert("lu", ("l", "u"));
    map.insert("lv", ("l", "v"));
    map.insert("luan", ("l", "uan"));
    map.insert("lve", ("l", "ve"));
    map.insert("lue", ("l", "ve"));
    map.insert("lun", ("l", "un"));
    map.insert("luo", ("l", "uo"));
    ...
    map.insert("mai", ("m", "ai"));
    map.insert("man", ("m", "an"));
    map.insert("mang", ("m", "ang"));
    map.insert("mao", ("m", "ao"));
    map.insert("me", ("m", "e"));
    map.insert("mei", ("m", "e"));
    map.insert("men", ("m", "en"));
    map.insert("meng", ("m", "eng"));
    map.insert("mi", ("m", "i"));
    map.insert("mian", ("m", "ian"));
    map.insert("miao", ("m", "iao"));
    map.insert("mie", ("m", "ie"));
    map.insert("min", ("m", "in"));
    map.insert("ming", ("m", "ing"));
    map.insert("miu", ("m", "iu"));
    map.insert("mo", ("m", "o"));
    map.insert("mou", ("m", "ou"));
    map.insert("mu", ("m", "u"));
    ...
    map.insert("nai", ("n", "ai"));
    map.insert("nan", ("n", "an"));
    map.insert("nang", ("n", "ang"));
    map.insert("nao", ("n", "ao"));
    map.insert("ne", ("n", "e"));
    map.insert("nei", ("n", "e"));
    map.insert("nen", ("n", "en"));
    map.insert("neng", ("n", "eng"));
    map.insert("ni", ("n", "i"));
    map.insert("nian", ("n", "ian"));
    map.insert("niang", ("n", "iang"));
    map.insert("niao", ("n", "iao"));
    map.insert("nie", ("n", "ie"));
    map.insert("nin", ("n", "in"));
    map.insert("ning", ("n", "ing"));
    map.insert("niu", ("n", "iu"));
    map.insert("nong", ("n", "ong"));
    map.insert("nou", ("n", "ou"));
    map.insert("nu", ("n", "u"));
    map.insert("nv", ("n", "v"));
    map.insert("nuan", ("n", "uan"));
    map.insert("nve", ("n", "ve"));
    map.insert("nue", ("n", "ve"));
    map.insert("nun", ("n", "un"));
    map.insert("nuo", ("n", "uo"));
    ...
    map.insert("pai", ("p", "ai"));
    map.insert("pan", ("p", "an"));
    map.insert("pang", ("p", "ang"));
    map.insert("pao", ("p", "ao"));
    map.insert("pei", ("p", "e"));
    map.insert("pen", ("p", "en"));
    map.insert("peng", ("p", "eng"));
    map.insert("pi", ("p", "i"));
    map.insert("pian", ("p", "ian"));
    map.insert("piao", ("p", "iao"));
    map.insert("pie", ("p", "ie"));
    map.insert("pin", ("p", "in"));
    map.insert("ping", ("p", "ing"));
    map.insert("po", ("p", "o"));
    map.insert("pou", ("p", "ou"));
    map.insert("pu", ("p", "u"));
    // q
    map.insert("qi", ("q", "i"));
    map.insert("qia", ("q", "ia"));
    map.insert("qian", ("q", "ian"));
    map.insert("qiang", ("q", "iang"));
    map.insert("qiao", ("q", "iao"));
    map.insert("qie", ("q", "ie"));
    map.insert("qin", ("q", "in"));
    map.insert("qing", ("q", "ing"));
    map.insert("qiong", ("q", "iong"));
    map.insert("qiu", ("q", "iu"));
    map.insert("qu", ("q", "v"));
    ...
    // r
    map.insert("ran", ("r", "an"));
    map.insert("rang", ("r", "ang"));
    map.insert("rao", ("r", "ao"));
    map.insert("re", ("r", "e"));
    map.insert("ren", ("r", "en"));
    map.insert("reng", ("r", "eng"));
    map.insert("ri", ("r", "ir"));
    map.insert("rong", ("r", "ong"));
    map.insert("rou", ("r", "ou"));
    map.insert("ru", ("r", "u"));
    map.insert("ruan", ("r", "uan"));
    map.insert("rui", ("r", "ui"));
    map.insert("run", ("r", "un"));
    map.insert("ruo", ("r", "uo"));
    // s
    ...
    map.insert("sai", ("s", "ai"));
    map.insert("san", ("s", "an"));
    map.insert("sang", ("s", "ang"));
    map.insert("sao", ("s", "ao"));
    map.insert("se", ("s", "e"));
    map.insert("sei", ("s", "e"));
    map.insert("sen", ("s", "en"));
    map.insert("seng", ("s", "eng"));
    map.insert("si", ("s", "ir"));
    map.insert("song", ("s", "ong"));
    map.insert("sou", ("s", "ou"));
    map.insert("su", ("s", "u"));
    map.insert("suan", ("s", "uan"));
    map.insert("sui", ("s", "ui"));
    map.insert("sun", ("s", "un"));
    map.insert("suo", ("s", "uo"));
    // t
    ...
    map.insert("tai", ("t", "ai"));
    map.insert("tan", ("t", "an"));
    map.insert("tang", ("t", "ang"));
    map.insert("tao", ("t", "ao"));
    map.insert("te", ("t", "e"));
    map.insert("tei", ("t", "e"));
    map.insert("teng", ("t", "eng"));
    map.insert("ti", ("t", "i"));
    map.insert("tian", ("t", "ian"));
    map.insert("tiao", ("t", "iao"));
    map.insert("tie", ("t", "ie"));
    map.insert("ting", ("t", "ing"));
    map.insert("tong", ("t", "ong"));
    map.insert("tou", ("t", "ou"));
    map.insert("tu", ("t", "u"));
    map.insert("tuan", ("t", "uan"));
    map.insert("tui", ("t", "ui"));
    map.insert("tun", ("t", "un"));
    map.insert("tuo", ("t", "uo"));
    // w
    ...
    map.insert("wai", ("w", "ai"));
    map.insert("wan", ("w", "an"));
    map.insert("wang", ("w", "ang"));
    map.insert("wei", ("w", "e"));
    map.insert("wen", ("w", "en"));
    map.insert("weng", ("w", "eng"));
    map.insert("wo", ("w", "o"));
    map.insert("wu", ("w", "u"));
    // x
    map.insert("xi", ("x", "i"));
    map.insert("xia", ("x", "ia"));
    map.insert("xian", ("x", "ian"));
    map.insert("xiang", ("x", "iang"));
    map.insert("xiao", ("x", "iao"));
    map.insert("xie", ("x", "ie"));
    map.insert("xin", ("x", "in"));
    map.insert("xing", ("x", "ing"));
    map.insert("xiong", ("x", "iong"));
    map.insert("xiu", ("x", "iu"));
    map.insert("xu", ("x", "v"));
    ...
    map.insert("ya", ("y", "a"));
    map.insert("yan", ("y", "an"));
    map.insert("yang", ("y", "ang"));
    map.insert("yao", ("y", "ao"));
    map.insert("ye", ("y", "e"));
    map.insert("yi", ("y", "i"));
    map.insert("yin", ("y", "in"));
    map.insert("ying", ("y", "ing"));
    map.insert("yong", ("y", "ong"));
    map.insert("you", ("y", "ou"));
    map.insert("yu", ("y", "v"));
    ...
    map.insert("zai", ("z", "ai"));
    map.insert("zan", ("z", "an"));
    map.insert("zang", ("z", "ang"));
    map.insert("zao", ("z", "ao"));
    map.insert("ze", ("z", "e"));
    map.insert("zei", ("z", "e"));
    map.insert("zen", ("z", "en"));
    map.insert("zeng", ("z", "eng"));
    map.insert("zi", ("z", "ir"));
    map.insert("zong", ("z", "ong"));
    map.insert("zou", ("z", "ou"));
    map.insert("zu", ("z", "u"));
    map.insert("zuan", ("z", "uan"));
    map.insert("zui", ("z", "ui"));
    map.insert("zun", ("z", "un"));
    map.insert("zuo", ("z", "uo"));
    // zh
    map.insert("zha", ("zh", "a"));
    map.insert("zhai", ("zh", "ai"));
    map.insert("zhan", ("zh", "an"));
    map.insert("zhang", ("zh", "ang"));
    map.insert("zhao", ("zh", "ao"));
    map.insert("zhe", ("zh", "e"));
    map.insert("zhei", ("zh", "e"));
    map.insert("zhen", ("zh", "en"));
    map.insert("zheng", ("zh", "eng"));
    map.insert("zhi", ("zh", "ir"));
    map.insert("zhong", ("zh", "ong"));
    map.insert("zhou", ("zh", "ou"));
    map.insert("zhu", ("zh", "u"));
    map.insert("zhua", ("zh", "ua"));
    map.insert("zhuai", ("zh", "uai"));
    map.insert("zhuan", ("zh", "uan"));
    map.insert("zhuang", ("zh", "uang"));
    map.insert("zhui", ("zh", "ui"));
    map.insert("zhun", ("zh", "un"));
    map.insert("zhuo", ("zh", "uo"));
    // ch
    map.insert("cha", ("ch", "a"));
    map.insert("chai", ("ch", "ai"));
    map.insert("chan", ("ch", "an"));
    map.insert("chang", ("ch", "ang"));
    map.insert("chao", ("ch", "ao"));
    map.insert("che", ("ch", "e"));
    map.insert("chen", ("ch", "en"));
    map.insert("cheng", ("ch", "eng"));
    map.insert("chi", ("ch", "ir"));
    map.insert("chong", ("ch", "ong"));
    map.insert("chou", ("ch", "ou"));
    map.insert("chu", ("ch", "u"));
    map.insert("chua", ("ch", "ua"));
    map.insert("chuai", ("ch", "uai"));
    map.insert("chuan", ("ch", "uan"));
    map.insert("chuang", ("ch", "uang"));
    map.insert("chui", ("ch", "ui"));
    map.insert("chun", ("ch", "un"));
    map.insert("chuo", ("ch", "uo"));
    // sh
    map.insert("sha", ("sh", "a"));
    map.insert("shai", ("sh", "ai"));
    map.insert("shan", ("sh", "an"));
    map.insert("shang", ("sh", "ang"));
    map.insert("shao", ("sh", "ao"));
    map.insert("she", ("sh", "e"));
    map.insert("shei", ("sh", "e"));
    map.insert("shen", ("sh", "en"));
    map.insert("sheng", ("sh", "eng"));
    map.insert("shi", ("sh", "ir"));
    map.insert("shou", ("sh", "ou"));
    map.insert("shu", ("sh", "u"));
    map.insert("shua", ("sh", "ua"));
    map.insert("shuai", ("sh", "uai"));
    map.insert("shuan", ("sh", "uan"));
    map.insert("shuang", ("sh", "uang"));
    map.insert("shui", ("sh", "ui"));
    map.insert("shun", ("sh", "un"));
...
impl G2PConverter {
    ...
    fn convert_japanese(&self, text: &str) -> Result<String> {
        let phonemes = text.chars().map(|c| format!("[{}]", c)).collect();
...
mod tests {
    ...
    fn test_bu_sandhi() {
        ...
        assert!(
            result.contains("u2"),
            "不 before 4th tone should become tone 2: got {}",
            result
        );
    }
    ...
    fn test_yi_sandhi() {
        ...
        assert!(
            result.contains("i4"),
            "一 before non-4th-tone should become tone 4: got {}",
            result
        );
        ...
        assert!(
            result2.contains("i2"),
            "一 before 4th-tone should become tone 2: got {}",
            result2
        );
    }
    ...
    fn test_neural_sandhi_word() {
        ...
        assert!(
            phones.contains("ir5"),
            "知识 last char should be tone 5: got {}",
            phones
        );
    }
    ...
    fn test_three_sandhi_three_char() {
        ...
        assert!(
            phones.contains("uo2"),
            "所 should change to tone 2 in 所有人: got {}",
            phones
        );
    }
}
